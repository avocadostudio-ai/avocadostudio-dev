...
export default function CatalogueLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <body>
        <header className="flex items-center justify-between px-6 py-2.5 border-b border-avocado-100 bg-white">
          <a href="/" aria-label="Avocado Studio home" className="inline-flex items-center">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/logo.svg" alt="Avocado Studio" className="h-7 w-auto" />
          </a>
